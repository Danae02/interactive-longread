    ...
    const interviews = [
        ...
        },
        {
            ...
            writtenInterview: [
                ...
                {
                    question: 'Hoe denkt u dat zo\'n soort wet gevolgen zou kunnen hebben voor de vee-industrie als ecocide iets strafbaars zou zijn? Dus bijvoorbeeld grote vleesbedrijven zoals verwerkers, zoals VanDrie Group of Vion Food Group – zouden zij dan aansprakelijk worden gehouden? Of wie zou dan schuldig zijn daarvan?',
                    answer: (
                        <div className="space-y-4">
                            ...
                            <p>Want inderdaad, die intentie – ook de baas van VanDrie Group zal echt niet 's ochtends uit zijn bed stappen en denken: "nou, we gaan even het oerwoud kapotmaken."</p>
                            ...
                            <p>Dus ik vind het lastig om te zeggen: is zo'n keten als VanDrie Group of Vion Food Group dan… ? Bovendien, dat is ook wel weer het mooie, ik kan daar heel erg over speculeren met jou, en ik kan er ook een idee over hebben. Daarom is het zo belangrijk dat er dit soort wetten komen, strafbaarstellingen, want dan is het uiteindelijk aan de rechter om te bepalen: ja, inderdaad, meneer of mevrouw VanDrie, u heeft een verantwoordelijkheid die dermate groot is voor een productieproces dat dermate bijdraagt aan vernietiging, dat daar aansprakelijkheid is. En bijvoorbeeld niet de consument.</p>
                ...
                },
                {
                    ...
                    answer: (
                        <div className="space-y-4">
                            ...
                            <p>Maar nee, VanDrie Group, Vion Food Group…, van de vier grote slachterijen moet ik zeggen. Daar heb ik nooit wat van gemerkt. Ironisch genoeg, terwijl zij daar veel meer bij te verliezen hadden natuurlijk. Maar die hebben waarschijnlijk gedacht: daar gaan we onze tijd niet aan verspillen.</p>
                        </div>
                    )
                },
                {
